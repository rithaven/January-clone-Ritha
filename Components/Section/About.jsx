    ...
    <div className="max-w-6xl p-4 m-auto bg-white pb-28">
      ...
      <div className="grid max-w-4xl grid-cols-3 gap-8 m-auto">
        {[
          ...
          return <img className="" src={e} alt="" key={index}/>;
        })}
        ...
        {[
          ...
          return <h3 className="font-bold" key={index}>{e}</h3>;
        })}
        {[
          ...
          return (
            <p className="flex font-bold text-blue-900" key={index}>
              <img className="h-6" src="../../chevron-right.svg" />
              {e}
            </p>
          );
        })}
        {[
          ...
          return (
            <p key={index} className="flex font-bold text-blue-900">
              <img className="h-6" src="../../chevron-right.svg" />
              {e}
            </p>
          );
